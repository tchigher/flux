...
impl<'a> WrappedStatement<'a> {
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn statement_as_native_variable_assignment(&self) -> Option<NativeVariableAssignment<'a>> {
    if self.statement_type() == Statement::NativeVariableAssignment {
      self.statement().map(|u| NativeVariableAssignment::init_from_table(u))
    } else {
      None
    }
  }
...
impl<'a> CallExpression<'a> {
  ...
  pub fn arguments(&self) -> Option<Property<'a>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<Property<'a>>>(CallExpression::VT_ARGUMENTS, None)
  }
  #[inline]
...
impl<'a: 'b, 'b> CallExpressionBuilder<'a, 'b> {
  ...
  pub fn add_arguments(&mut self, arguments: flatbuffers::WIPOffset<Property<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Property>>(CallExpression::VT_ARGUMENTS, arguments);
  }
  #[inline]
